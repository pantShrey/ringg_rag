...
const Slider = React.forwardRef<
  React.ComponentRef<typeof SliderPrimitive.Root>,  // Changed from ElementRef
...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-secondary border border-muted-foreground/20 shadow-inner">
